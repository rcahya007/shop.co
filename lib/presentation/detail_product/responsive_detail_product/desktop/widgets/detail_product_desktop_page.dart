...
import 'package:shop_co/presentation/detail_product/responsive_detail_product/desktop/widgets/also_like_page.dart';

class DetailProductDesktopPage extends StatefulWidget {
  const DetailProductDesktopPage({super.key});

  @override
  State<DetailProductDesktopPage> createState() =>
      _DetailProductDesktopPageState();
}

class _DetailProductDesktopPageState extends State<DetailProductDesktopPage>
                    ...
                    children: [
                      Text(
                        ...
                        style: satoshiRegular.copyWith(
                            fontSize: 16, color: colorBlack.withOpacity(0.6)),
                      ),
                      const SizedBox(
                        width: 6,
                      ),
                        ...
                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(20),
                                              child: Image.asset(
                                                  'assets/images/newArrivals4.png'),
                                            ),
                                          ),
                                          const SizedBox(
                                            height: 14,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'One Life Graphic T-shirt'.toUpperCase(),
                                ...
                                Row(
                                  children: [
                                    RatingBar.builder(
                                      ...
                                      itemCount: 5,
                                      itemPadding:
                                          const EdgeInsets.only(right: 5.3),
