...
import 'package:shop_co/presentation/detail_product/responsive_detail_product/tablet/widgets/also_like_tablet_page.dart';

class DetailProductTabletPage extends StatefulWidget {
  const DetailProductTabletPage({super.key});

  @override
  State<DetailProductTabletPage> createState() =>
      _DetailProductTabletPageState();
}

class _DetailProductTabletPageState extends State<DetailProductTabletPage>
